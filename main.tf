...
resource "azuread_conditional_access_policy" "Admin1" {
  display_name = "Admin 1 - Require MFA & Session Controls"
...
resource "azuread_conditional_access_policy" "Workplace1" {
